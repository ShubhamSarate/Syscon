...
export default function ContactModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto px-4 py-6">
      ...
      <div className="relative w-full max-w-[480px] bg-white rounded-[32px] border border-gray-100 shadow-2xl p-8 sm:p-10 z-10 transition-all transform scale-100 duration-300">
        {/* Close Button */}
        <button
          onClick={() => setIsOpen(false)}
        ...
        {submitStatus === "success" ? (
          ...
          <form onSubmit={handleSubmit}>
            {/* Title */}
            <h3 className="text-xl font-bold text-gray-900 mb-6 font-sans tracking-tight">
              ...
              {SERVICES.map((service) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[17px] text-gray-800 font-normal leading-tight">
                      {service}
                    </span>
                  </label>
                );
            ...
            <button
              ...
              className={`w-full text-white py-4 px-6 rounded-2xl text-lg font-semibold transition-all shadow-md select-none flex items-center justify-center gap-2 ${
                isSubmitting
                  ? "bg-[#9ba8b6]/80 cursor-not-allowed"
                  : "bg-[#a2b0be] hover:bg-[#909ea8] active:scale-[0.99] hover:shadow-lg"
              }`}
            >
              {isSubmitting ? (
                <>
